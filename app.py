...
# Application Header (Compact and clean)
st.markdown("<div class='main-title'>🏭 Production & Wage Management System</div>", unsafe_index=True)
st.markdown("<div class='sub-title'>කර්මාන්තශාලා නිෂ්පාදන, දෛනික වැටුප් සහ වියදම් කළමනාකරණ පද්ධතිය</div>", unsafe_index=True)
st.markdown("---")
...
# 5. Control Panel Section
    ...
    # We reset the confirmation alert when prices are manually saved
    ...
    if st.button("Save Material Prices (අමුද්‍රව්‍ය මිල සේව් කරන්න)"):
        ...
        st.session_state.price_confirmed = True # Reset alert automatically since they just edited it
